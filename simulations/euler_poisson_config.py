...
class EulerPoissonConfig:
    ...
    rho_amplitude: float = 0.05
    u_amplitude: float = 0.05
    ...
    # Saved filenames
    dataset_filename: str = "euler_poisson_dataset.npz"
    figure_filename: str = "euler_poisson_examples.png"